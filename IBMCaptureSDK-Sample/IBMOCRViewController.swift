...
class IBMOCRViewController: UIViewController {
    ...
    let ocrEngine = ICPTesseractOcrEngine(tessDataPrefixes: ["eng"], andTessdataAbsolutePath: NSBundle.mainBundle().bundlePath)
    ...
    //MARK: Actions
    @IBAction func performOCR(sender: AnyObject) {
