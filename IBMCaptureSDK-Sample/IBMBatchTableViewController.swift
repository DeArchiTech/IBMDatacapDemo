...
class IBMBatchTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier(IBMBatchCellIdentifier, forIndexPath: indexPath)
    ...
    */
    ...
    //MARK: - Actions
    @IBAction func addDocument(sender: AnyObject) {
     ...
     */
    @IBAction func submitBatch(sender: UIBarButtonItem) {
    ...
    func uploadBatchCompletion(sender:UIBarButtonItem) -> ICPSessionManagerUploadCompletion {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if let documentTableViewController = segue.destinationViewController as? IBMDocumentTableViewController where segue.identifier == IBMBatchToDocumentSegue {
